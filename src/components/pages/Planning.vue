							...
							<div class="card-body">
								<draggable v-model="$store.state.werkvoorbereiding.planning">
									<div v-bind:key="'Planning'+planningIndex" v-for="(planning, planningIndex) in planning" class="planning shadow-sm">
										<div class="row">
											...
											<div class="col-md-3 col-xl-2">
												<div class="input-group mb-2">
													...
													<select data-toggle="tooltip" data-placement="top" title="" required="required" class="form-control"
													 data-original-title="Voor welk component wil je een planning maken?" v-model="planning.component">
											...
											<div class="col-md-3 col-xl-2">
												<div class="input-group mb-2">
													<select data-toggle="tooltip" data-placement="top" title="" required="required" class="form-control"
													 data-original-title="Voor welk onderdeel?" v-model="planning.onderdeel">
											...
											<div class="col-12 col-md-3 col-xl-2">
												<div class="input-group">
													<button type="button" class="btn btn-teal btn-sm btn-block ml-auto" @click="newStap(planningIndex)">
											...
											<div class="col-12 col-md-2 col-xl-1">
												<div class="input-group">
													<button type="button" class="btn btn-danger btn-block btn-sm" @click="removePlanning(planningIndex)">
										...
										<draggable v-model="$store.state.werkvoorbereiding.planning[planningIndex].stappen">
											<div class="row stap shadow-sm ml-4" v-bind:key="index" v-for="(stap, index) in stappen(planningIndex)">
												<!-- Stap -->
												<div class="col-12 col-md-4 col-xl-2 pl-0">
													<div class="input-group mb-2">
														...
														<select data-toggle="tooltip" data-placement="top" required="required" class="form-control"
														 data-original-title="Welke stap ga je doen?" v-model="stap.stap">
												...
												<div class="col-12 col-md-4 col-xl-2">
													<div class="input-group mb-2">
														<select data-toggle="tooltip" data-placement="top" required="required" class="form-control"
														 data-original-title="Voor welke werkzaamheid?" v-model="stap.werkzaamheid">
															<option value="" hidden selected disabled>Kies..</option>
												...
												<div class="col-12 col-md-4 col-xl-2">
													<div class="input-group mb-2">
														<select data-toggle="tooltip" data-placement="top" required="required" class="form-control"
														 data-original-title="Welke bewerking ga je uitvoeren?" v-model="stap.bewerking">
															<option value="" hidden selected disabled>Kies..</option>
												...
												<div class="col-12 col-md-3 col-xl-2">
													<div class="input-group mb-2">
														<select data-toggle="tooltip" data-placement="top" required="required" class="form-control"
														 data-original-title="Heb je een gereedschap nodig?" v-model="stap.gereedschap">
												...
												<div class="col-4 col-md-2 col-xl-1">
													<div class="input-group mb-2">
														<input type="number" placeholder="Insteltijd" data-toggle="tooltip" data-placement="top" required="required"
														 class="form-control" data-original-title="Hoeveel minuten ben je bezig met instellen?" v-model="stap.insteltijd">
													</div>
												</div>
												<!-- Bewerkingstijd -->
												<div class="col-4 col-md-2 col-xl-1">
													<div class="input-group mb-2">
														<input type="number" placeholder="Bewerkingstijd" data-toggle="tooltip" data-placement="top" required="required"
														 class="form-control" data-original-title="Hoeveel minuten ben je bezig met één bewerking?" v-model="stap.bewerkingstijd">
													</div>
												</div>
												<!-- Aantal -->
												<div class="col-4 col-md-2 col-xl-1">
													<div class="input-group mb-2">
														<input type="number" placeholder="Aantal" data-toggle="tooltip" data-placement="top" required="required"
														 class="form-control" data-original-title="Hoe vaak ga je dezelfde handeling uitvoeren?" v-model="stap.aantal">
													</div>
												</div>
												<!-- Verwijderknop -->
												<div class="col-12 col-md-2 col-xl-1">
													<div class="input-group mb-2">
														<button type="button" class="btn btn-danger btn-block btn-sm" @click="removeStap(planningIndex, index)">
															<i class="fa fa-trash"></i>
														</button>
													</div>
												</div>
								...
								<div class="row">
									<div class="col-md-6 col-lg-4 col-xl-3">
										<button type="button" class="btn btn-block" @click="newOnderdeel()">
									...
									<div class="col-md-6 col-lg-4 col-xl-3">
										<button type="button" class="btn float-right btn-block" @click="$store.state.appData.page = -5">
