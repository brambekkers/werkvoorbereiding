				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="row mt-3 mx-3 justify-content-center">
							...
							<div class="col-md-4 text-center"><button class="btn btn-fill btn-danger btn-block" @click="deleteWvb()">Verwijder project</button></div>
						</div>
						<hr class="mb-0">
						<div class="card-body table-responsive">
							<table class="table table-hover table-striped">
								...
								<tbody>
									<tr v-bind:key="index" v-for="(project, index) in projecten" 
									@click="selectWvb(index)" 
									:class="{ selected: (index === selectedWvb) }">
										<td>{{index+1}}</td>
