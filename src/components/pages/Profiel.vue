					...
					<div class="card mt-4">
						...
						<div class="card-body">
							<form v-if="profiel">
								<div class="row">
									<div class="col-md-5">
										<div class="form-group"><label>Voornaam</label> <input
												type="text"
									...
									<div class="col-md-2">
										<div class="form-group"><label>Tussenvoegsel</label> <input
												type="text"
									...
									<div class="col-md-5">
										<div class="form-group"><label>Achternaam</label> <input
												type="text"
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group"><label for="exampleInputEmail1">Email adres</label> <input
												type="email"
												placeholder="Email"
									...
									<div class="col-md-3">
										<div class="form-group"><label>Klas</label> <input
												type="text"
												placeholder="Klas"
