				...
				>
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<!-- Gereedschap -->
								<div class="border-right" :class="{ 'col-md-4 col-sm-6': gereedschap.userMade, 'col-sm-6': !gereedschap.userMade }">
	...
	methods: {
		...
		addUserTool() {
			Swal.fire({
				...
				if (!this.gereedschap['userMade']) this.$set(this.gereedschap, 'userMade', {});
				if (result.value) this.$set(this.gereedschap.userMade, result.value, true);
			});
		},
		removeUserTool(key) {
