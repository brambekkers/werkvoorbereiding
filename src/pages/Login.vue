			...
			<div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 mx-auto">
				<form role="form" @submit.prevent="login()">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									...
									<h4 class="text-center mt-2 mb-0">Of login je met je e-mail</h4>
					...
					<div class="text-center">
						<label
							>Nog geen account? <router-link to="/register" class="link">Account aan maken</router-link><br />
							of <router-link to="/forgotPw" class="link">wachtwoord vergeten</router-link></label
						>
					</div>
				</form>
			</div>
