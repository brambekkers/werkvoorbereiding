								...
								<div class="col-md-12">
									...
									<div class="collapse" id="saveAsButtons">
										<div class="card card-body my-0">
											<p>
												Je kunt de werkvoorbereiding die je hebt gemaakt downloaden als een
												afbeelding of PDF.
											</p>
											<p>
												<strong>Let op:</strong>Dit bestand kun je later <u>niet</u> opnieuw
												inlezen in dit programma. Gebruik daar de <u>opslaan</u> knop voor.
											</p>
											...
											<div class="socialIcons">
												...
												<div class="socialIcon email" @click="opslaanAlsCanvas('pdf')">
								...
								<div class="col-md-12">
									...
									<div class="collapse" id="shareButtons">
										<div class="card card-body my-0">
											...
											<p v-if="!wvbid && userid">
												<strong>Let op:</strong> Je hebt geen werkvoorbereiding geselecteerd
												om te delen
											</p>
											...
											<div class="socialIcons">
												<ShareNetwork
													...
													:key="share.network"
												>
													<div class="socialIcon" :class="share.network">
