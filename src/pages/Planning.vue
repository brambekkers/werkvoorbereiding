										...
										<div class="row">
											...
											<div class="col-12 col-md-2 col-xl-1">
												<div class="input-group">
													<button
														type="button"
														class="btn btn-danger btn-block btn-sm w-100"
												...
												<div class="col-12 col-md-4 col-xl-2">
													<div class="row">
														...
														<div class="col-12 col-sm-6">
															<button
																type="button"
																class="btn btn-block button mt-2"
																data-toggle="collapse"
																:data-target="`#extraInfo_${planningIndex}_${index}`"
																aria-expanded="true"
														...
														<div class="col-12 col-sm-6">
															<button
																type="button"
																class="btn btn-block button btn-danger mt-2"
